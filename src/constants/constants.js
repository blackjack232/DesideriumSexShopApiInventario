...
module.exports = {
  ERROR_MESSAGES: {
    ...
    NO_SE_ENVIARON_IMAGENES: 'No se enviaron imágenes',
    EL_PRODUCTO_YA_EXISTE: 'El producto ya existe',
    ERROR_EN_EL_SERVIDOR: 'Error en el servidor',
    PRODUCTO_NO_ENCONTRADO: 'Producto no encontrado',
    TODOS_LOS_CAMPOS_SON_REQUERIDOS: 'Todos los campos son requeridos',
    CATEGORIA_NO_VALIDA: 'Categoría no válida'
  ...
  SUCCESS_MESSAGES: {
    ...
    PRODUCTO_GUARDADO_EXITOSAMENTE: 'Producto guardado exitosamente',
    PRODUCTOS_RECUPERADOS_EXITOSAMENTE: 'Productos recuperados exitosamente',
    PORDUCTO_ELIMINADO_EXITOSAMENTE :'Producto eliminado'
  }
};
